...
class LevoitCore400SSpec extends HubitatSpec {
    ...
    def "setLevel(60) emits speed attribute as named band 'high', not raw '3' (Core 400S)"() {
    ...
    def "setLevel(100) emits speed attribute as named band 'max', not raw '4' (Core 400S)"() {
