...
- **BP16 live-verified footer** — analogous to BP14's footer in `qa-agent.md`. Add after first community report confirms post-reboot debug-watchdog self-heal works in the field.
